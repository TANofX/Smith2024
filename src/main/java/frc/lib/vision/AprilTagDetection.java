...
public class AprilTagDetection {
  ...
  public static Transform3d cameraToRobot2 = new Transform3d(Units.inchesToMeters(12.625), Units.inchesToMeters(10.75), Units.inchesToMeters(17.5), new Rotation3d(0, Units.degreesToRadians(45), Units.degreesToRadians(0)));
